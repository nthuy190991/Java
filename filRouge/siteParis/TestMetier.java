	...
	public static void testValiditePasswordGestionnaire () {
		...
		try {
			...
			try {
				...
				System.out.println("validitePasswordGestionnaire avec un password gestionnaire incorrect n'a pas levé l'exception MetierException");
			}
			catch (MetierException e) { }
			catch (Exception e) { 
				System.out.println("validitePasswordGestionnaire avec un password gestionnaire incorrect n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			}
	...
	public static void testValiditePasswordJoueur () {
		...
		try {
			...
			try {
				...
				System.out.println("validitePasswordJoueur avec un joueur inexistant (pipot) n'a pas levé l'exception JoueurInexistantException");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
				System.out.println("validitePasswordJoueur avec un joueur inexistant (pipot)  n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("validitePasswordJoueur avec un pseudo invalide (non instancié) n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("validitePasswordJoueur avec un pseudo invalide (non instancié) n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.validitePasswordJoueur(new String("aure"), null);
				System.out.println("validitePasswordJoueur avec un password  invalide (non instancié) d'un joueur existant (aure) n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("validitePasswordJoueur avec un password invalide (non instancié) n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}


			try {
				siteDeParisMetier.validitePasswordJoueur(new String("momo"), "az32");
				System.out.println("validitePasswordJoueur avec un password  invalide (moins de 8 caractères) d'un joueur existant (momo) n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("validitePasswordJoueur avec un password invalide (moins de 8 caractères) d'un joueur existant (momo)  n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("validitePasswordJoueur avec un password  incorrect d'un joueur existant (aure) n'a pas levé l'exception JoueurInexistantException");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
				System.out.println("validitePasswordJoueur avec un password incorrect d'un joueur existant (aure)  n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("validitePasswordJoueur sur des joueurs existants a  levé l'exception  " + e.getClass().getName());
			}
   ...
   public static void testCrediterDebiterJoueur () {
		...
		try {
			...
			try {
				...
				System.out.println("crediter un joueur avec un nom incorrect n'a pas levé l'exception JoueurException");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
				System.out.println("crediter un joueur avec un nom incorrect n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.crediterJoueur(null, new String ("Sylvain"), new String ("zinzin"), 30, new String("ilesCaimans"));
				System.out.println("crediter un joueur avec un nom invalide n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("crediter un joueur avec un nom invalide n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.crediterJoueur(new String ("Nadou"), new String ("Silvain"), new String ("zinzin"), 30, new String("ilesCaimans"));
				System.out.println("crediter un joueur avec un prenom incorrect n'a pas levé l'exception JoueurException");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
				System.out.println("crediter un joueur avec un prenom incorrect n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.crediterJoueur(new String ("Nadou"), null, new String ("zinzin"), 30, new String("ilesCaimans"));
				System.out.println("crediter un joueur avec un prenom invalide n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("crediter un joueur avec un prenom invalide n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			
			
			try {
				siteDeParisMetier.crediterJoueur(new String ("Nadou"), new String ("Sylvain"), new String (""), 30, new String("ilesCaimans"));
				System.out.println("crediter un joueur avec un pseudo invalide n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("crediter un joueur avec un pseudo invalide n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("crediter un joueur inexistant n'a pas levé l'exception JoueurInnexistantExeption");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
			...
			try {
				...
				System.out.println("\n crediter un joueur de maniere correcte a levé une exception ");
				e.printStackTrace();
			}
			...
			try {
				...
				System.out.println("le credit de bernard devrait être inférieur a 301, et l'exception JoueurException aurait dû être levée");
			}
			catch (JoueurException e) { } 
			catch (Exception e) { 
				System.out.println("le credit de bernard devrait être inférieur a 301, et l'exception JoueurException aurait dû être levée mais c'est : " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("le credit de bernard devrait être égal a 300, et l'exception JoueurException n'aurait pas dû être levée");
			} 
			catch (Exception e) { 
				System.out.println("le credit de bernard devrait être égal a 300, et aucune exception n'aurait dû être levée mais c'est : " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("\n debiter un joueur de maniere correcte a levé une exception ");
				e.printStackTrace();
			}
			...
			try {
				...
				System.out.println("debiter un joueur avec un nom incorrect n'a pas levé l'exception JoueurException");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
				System.out.println("debiter un joueur avec un nom incorrect n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.debiterJoueur(null, new String ("Sylvain"), new String ("zinzin"), 30, new String("ilesCaimans"));
				System.out.println("debiter un joueur avec un nom invalide n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("debiter un joueur avec un nom invalide n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.debiterJoueur(new String ("Nadou"), new String ("Silvain"), new String ("zinzin"), 30, new String("ilesCaimans"));
				System.out.println("debiter un joueur avec un prenom incorrect n'a pas levé l'exception JoueurException");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
				System.out.println("debiter un joueur avec un prenom incorrect n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.debiterJoueur(new String ("Nadou"), null, new String ("zinzin"), 30, new String("ilesCaimans"));
				System.out.println("debiter un joueur avec un prenom invalide n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("debiter un joueur avec un prenom invalide n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			
			
			try {
				siteDeParisMetier.debiterJoueur(new String ("Nadou"), new String ("Sylvain"), new String (""), 30, new String("ilesCaimans"));
				System.out.println("debiter un joueur avec un pseudo invalide n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("debiter un joueur avec un pseudo invalide n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("debiter un joueur innexistant n'a pas levé l'exception JoueurInnexistantExeption");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
				System.out.println("debiter un joueur innexistant n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("debiter joueur innexistant n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("debiter un joueur avec une somme en jetons negative n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("debiter un joueur avec une somme en jetons insufisante n'a pas levé l'exception JoueurException ");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("debiter un joueur avec une somme en jetons insufisante n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			}
	...
	public static void testMiserVainqueur () {
		...
		try {
			...
			try {
				...
				System.out.println("parier sur un vainqueur avec un pseudo invalide (non instancié)  n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("parier sur un vainqueur avec un pseudo invalide (non instancié)  n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("parier sur un vainqueur avec un pseudo invalide (moins de 4 caractères)  n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("parier sur un vainqueur avec un pseudo invalide (moins de 4 caractères)  n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("parier sur un vainqueur avec un pseudo invalide (avec '-')  n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("parier sur un vainqueur avec un pseudo invalide (avec '-')  n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			
			// le pseudo incorrect (il n'existe pas le joueur avec le même pseudo)
			...
			try {
				...
				System.out.println("parier sur un vainqueur avec un pseudo incorrect (non existant)  n'a pas levé l'exception JoueurInexistantException");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
				System.out.println("parier sur un vainqueur avec un pseudo incorrect (non existant)  n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("parier sur un vainqueur avec un password du joueur invalide (non instancié)  n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("parier sur un vainqueur avec un password du joueur invalide (non instancié)  n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("parier sur un vainqueur avec un password du joueur invalide (moins de 8 caractères)  n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("parier sur un vainqueur avec un password du joueur invalide (moins de 8 caractères)  n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("parier sur un vainqueur avec un password du joueur invalide (avec '-')  n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("parier sur un vainqueur avec un password du joueur invalide (avec '-')  n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("parier sur un vainqueur avec un password du joueur incorrect  n'a pas levé l'exception JoueurInexistantException");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
				System.out.println("parier sur un vainqueur avec un password du joueur incorrect  n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
			}
			
			// le compte en jetons du joueur est insuffisant (la somme en jetons à miser (1790) être inférieur à le compte en jetons du joueur (1789))
			try {
				...
				System.out.println("parier sur un vainqueur avec un miseEnJetons être inférieur à compteEnJetons du joueur  n'a pas levé l'exception JoueurException");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("parier sur un vainqueur avec un miseEnJetons être inférieur à compteEnJetons du joueur  n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}

			// la somme en jetons est négative
			try {
				...
				System.out.println("parier sur un vainqueur avec une miseEnJetons négative  n'a pas levé l'exception MetierException");
			}
			catch (MetierException e) { }
			catch (Exception e) { 
				System.out.println("parier sur un vainqueur avec une miseEnJetons négative  n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			}
			
			// parier dans une compétition inexistante
			try {
				...
				System.out.println("parier dans une compétition inexistante  n'a pas levé l'exception CompetitionInexistanteException");
			}
			catch (CompetitionInexistanteException e) { }
			catch (Exception e) { 
				System.out.println("parier dans une compétition inexistante  n'a pas levé l'exception CompetitionInexistanteException mais " + e.getClass().getName());
			}
			
			// le nom de la compétition invalide
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 40, null, new String("Lyon"));
				System.out.println("parier dans une compétition avec un nom invalide (non instancié)  n'a pas levé l'exception CompetitionException");
			}
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("parier dans une compétition avec un nom invalide (non instancié)  n'a pas levé l'exception CompetitionException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("parier dans une compétition avec un nom invalide (avec espace)  n'a pas levé l'exception CompetitionException");
			}
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("parier dans une compétition avec un nom invalide (avec espace)  n'a pas levé l'exception CompetitionException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 40, new String("finale|RG2012"), new String("Lyon"));
				System.out.println("parier dans une compétition avec un nom invalide (caractère |)  n'a pas levé l'exception CompetitionException");
			}
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("parier dans une compétition avec un nom invalide (caractère |)  n'a pas levé l'exception CompetitionException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 40, new String("RGA"), new String("Lyon"));
				System.out.println("parier dans une compétition avec un nom invalide (moins de 4 caractères)  n'a pas levé l'exception CompetitionException");
			}
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("parier dans une compétition avec un nom invalide (moins de 4 caractères)  n'a pas levé l'exception CompetitionException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("parier dans une compétition avec un nom du compétiteur invalide (non instancié)  n'a pas levé l'exception CompetitionException");
			}
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("parier dans une compétition avec un nom du compétiteur invalide (non instancié)  n'a pas levé l'exception CompetitionException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("parier dans une compétition avec un nom du compétiteur invalide (avec espace)  n'a pas levé l'exception CompetitionException");
			}
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("parier dans une compétition avec un nom du compétiteur invalide (avec espace)  n'a pas levé l'exception CompetitionException mais " + e.getClass().getName());
			}
			...
			try {
				...
				System.out.println("parier dans une compétition avec un nom du compétiteur invalide (moins de 4 caractères)  n'a pas levé l'exception CompetitionException");
			}
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("parier dans une compétition avec un nom du compétiteur invalide (moins de 4 caractères)  n'a pas levé l'exception CompetitionException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 40, new String("ChampionnatDeFrance2012"), new String("Lyon*"));
				System.out.println("parier dans une compétition avec un nom du compétiteur invalide (caractère *)  n'a pas levé l'exception CompetitionException");
			}
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("parier dans une compétition avec un nom du compétiteur invalide (caractère *)  n'a pas levé l'exception CompetitionException mais " + e.getClass().getName());
			}
			
			// parier sur un vainqueur de manière correct
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 40, new String("ChampionnatDeFrance2012"), new String("Lyon"));
			}
			catch (Exception e) { 
				System.out.println("parier dans une compétition correctement mais " + e.getClass().getName());
			}
	...
	public static void testConsulterJoueurs () {
		...
		try {
			...
			try {
				...
				System.out.println("consulterCompetiteurs avec un password invalide (moins de 4 caractères) n'a pas levé l'exception MetierException ");
			}
			catch (MetierException e) { }			
			catch (Exception e) { 
				System.out.println("consulterCompetiteurs avec un password invalide (moins de 4 caractères) n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			}

			try {
				siteDeParisMetier.consulterJoueurs("inconnu");
				System.out.println("consulterCompetiteurs avec un password incorrect n'a pas levé l'exception MetierException ");
			}
			catch (MetierException e) { }			
			catch (Exception e) { 
				System.out.println("consulterCompetiteurs avec un password incorrect n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			}
